 ...
 * stanzas 4–5 and the coda were supplied and corrected by the user. The screen
 * sets them with the app's own rubrication rule at SINKSAR scope, so the salam
 * opening and every holy name are drawn in red — see Rubrication.
 */
