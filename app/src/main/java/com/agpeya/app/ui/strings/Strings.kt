...
interface Strings {
    ...
    /** Headline and body when the plan is waiting on a day that was missed. */
    val readingResumeTitle: String
    fun readingResumeBody(day: Int, passages: String): String
    fun readingResumePlain(day: Int): String
    ...
    val alarmVibratesTitle: String
    val alarmVibratesBody: String
    val alarmTurnOnSound: String
    val alarmKeepVibrating: String
    ...
    val aboutPrivacyLink: String
    val rateAppTitle: String
    val rateAppSubtitle: String
    val supportEmailTitle: String
    val supportEmailSubtitle: String
...
object AmharicStrings : Strings {
    ...
    override fun canonSection(key: String) = when (key) {
        "Pentateuch" -> "የሕግ መጻሕፍት"
        "Historical" -> "የታሪክ መጻሕፍት"
        "PoetryWisdom" -> "የጥበብና የመዝሙር መጻሕፍት"
    ...
    override val readingResumeTitle = "ካቆሙበት ይቀጥሉ"
    override fun readingResumeBody(day: Int, passages: String) =
        "ዕለት ${com.agpeya.app.ui.reading.geezNumeral(day)} ላይ ቆመዋል · $passages"
    override fun readingResumePlain(day: Int) =
        "ዕለት ${com.agpeya.app.ui.reading.geezNumeral(day)} ላይ ቆመዋል"
    ...
    override val alarmVibratesBody =
        "ሰዓቱ ሲደርስ ስልክዎ ይነዝራል እንጂ ድምፅ አያሰማም — በቅዳሴና በጸሎት ላይ እንዳያስተጋባ። " +
            "ድምፅ ቢሻዎት አሁን ማብራት ይችላሉ፤ በኋላም ከቅንብሮች › ጸሎት ውስጥ።"
    override val alarmTurnOnSound = "ድምፅ አብራ"
    override val alarmKeepVibrating = "ንዝረት ይቆይ"
    ...
    override val aboutPrivacyLink = "ሙሉውን የግላዊነት ፖሊሲ ያንብቡ"
    override val rateAppTitle = "መተግበሪያውን ይገምግሙ"
    override val rateAppSubtitle = "በPlay Store ደረጃ ይስጡት"
    override val supportEmailTitle = "በኢሜይል ያግኙን"
    override val supportEmailSubtitle = "አስተያየት ወይም ጥያቄ ይላኩ"
...
object EnglishStrings : Strings {
    ...
    override fun canonSection(key: String) = when (key) {
        "Pentateuch" -> "The Law"
        "Historical" -> "History"
        "PoetryWisdom" -> "Wisdom and psalms"
    ...
    override val readingResumeTitle = "Continue where you stopped"
    override fun readingResumeBody(day: Int, passages: String) = "You stopped at day $day · $passages"
    override fun readingResumePlain(day: Int) = "You stopped at day $day"
    ...
    override val alarmVibratesBody =
        "When an hour arrives your phone vibrates rather than rings, so it cannot " +
            "sound out during ቅዳሴ or in prayer. Turn sound on now if you would rather, " +
            "or later in Settings › Prayer."
    override val alarmTurnOnSound = "Turn on sound"
    override val alarmKeepVibrating = "Keep vibrating"
    ...
    override val aboutPrivacyLink = "Read full privacy policy"
    override val rateAppTitle = "Rate the app"
    override val rateAppSubtitle = "Leave a review on Google Play"
    override val supportEmailTitle = "Email the maintainer"
    override val supportEmailSubtitle = "Send feedback or questions"
