# Archived implementation reference — v0.2.6

> Historical snapshot retained on 2026-09-16. The descriptions, paths, gaps, and links below belong to v0.2.6 and are not current instructions. See [the current implementation reference](../IMPLEMENTATION.md) and [project status](../PROJECT_STATUS.md).
